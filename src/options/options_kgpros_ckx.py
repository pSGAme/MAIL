...
class Options:
    ...
    def __init__(self):
        ...
        parser = argparse.ArgumentParser(description='ProS ckx')

        # ckx newly append
        parser.add_argument('-number_of_white', '--number_of_white', default=16, type=int,
                            help='number of prompts that are no trained')
        parser.add_argument('-VPT', '--VPT', action="store_true", help='only visual prompt tuning')
        parser.add_argument('-lmda', '--lmda', default=16, type=float,
                            help='regulation factor')
        ...
        data_path = '/root/autodl-tmp/data/downloads'
        parser.add_argument('-dataset_path', '--dataset_path', default=data_path, type=str, help='Path of three datasets')
