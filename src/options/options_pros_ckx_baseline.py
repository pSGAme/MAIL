...
class Options:
    ...
    def __init__(self):
        ...
        root_path = '/data1/ckx/mycode/Pros'
        parser.add_argument('-code_path', '--code_path', default=root_path, type=str, help='code path of ProS')
        parser.add_argument('-dataset_path', '--dataset_path', default=os.path.join(root_path, 'src/data/downloads'), type=str, help='Path of three datasets')
